  ...
  $('#s7').click(function(){                           
    ...
    $('.bdy #location').text("Location:");
    $('.bdy #desc').html("<p>محلات اللحظة الأخيرة توفر فرصة أخرى للتسوق واقتناءا منتجات مختارة من السوق الحرة لجميع المسافرين</p>");
  });
  $('#s8').click(function(){
                $('.part2 #icon').attr("src","photo/gourmet-store.png");
                $('.bdy #title').text("محلات اللحظة الأخيرة(A, B &C)");
                $('.bdy #location').text("Location:");
                $('.bdy #desc').html("<p>محلات اللحظة الأخيرة توفر فرصة أخرى للتسوق واقتناءا منتجات مختارة من السوق الحرة لجميع المسافرين</p>");
              });
              $('#s9').click(function(){
